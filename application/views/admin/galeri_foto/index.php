<div class="mb-6">
    <div class="flex justify-between items-center">
        ...
        <a href="<?= base_url('admin/galeri_foto/tambah') ?>" class="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition">
